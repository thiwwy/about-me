...
Web Starter Kit using Express, PUG and SASS.
(SASS automated with grunt)
...
3 - Run app.js -> node app.js

N.B.: In case of Error "Requiring external module babel-register"
...
to keep your application running and to check the file for your style at the same time you can open another tab in your terminal.
(reference: http://askubuntu.com/questions/380315/command-to-open-new-tab-in-the-current-terminal)

1 - install xdotool -> sudo apt-get install xdotool
2 - Open a second tab -> xdotool key ctrl+shift+t
Now to open a new tab in the current opened terminal you can press SHIFT+CTRL+T

##SASS - Change your style with Material Design Lite
open

app/style/src/_variables.scss
...
N.B.: This application is using Material Design Lite. Use this reference to change the settings: https://material.io/guidelines/style/color.html#color-color-palette
